 ...
 * @author akhare
 */
public class EBMExtractor extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        String appId = "ReactionX.EBMExtractor";
	...
	try 
        ...
        if (!alreadyRunning)
        {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("EBMExtractorDoc.fxml"));
            ...
            stage.setTitle("EBM Extractor Tools");
